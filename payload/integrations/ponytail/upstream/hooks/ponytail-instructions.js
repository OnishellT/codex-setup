...
// Codex hooks consume this private resource directly; it is deliberately not a
// discoverable Codex skill.
const SKILL_PATH = path.join(__dirname, '..', 'instructions.md');
